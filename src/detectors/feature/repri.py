...
class RepriDetector(FeatureDetector):
    ...
    def compute_probas(self, feat_s, X, W):
        ...
        return -self.lambda_ * similarities, torch.cat([outlierness, 1 - outlierness], dim=1)
    ...
    def __call__(self, support_features, query_features, **kwargs):
        ...
        kwargs['intra_task_metrics']['secondary_metrics']['pi_diff_oracle'].append(pi_diff_with_oracle)
